...
function levelBadge(item) {
    ...
    } else if (item.level === 0 && !item.consolidated) {
        // A real chain-opening full is a Baseline from day one (even before its
        // first Delta lands); consolidated points are standalone Fulls instead.
